...
def find_sym(sym,sev) -> dict:
    ...
    for result_item in results:
        result_item = str(result_item)[2:-3]
...
# update_record
def update_sym_record(user:str,sym:str,ill,sev:int) -> None:
    conn = db.connect()
   
    today = date.today()
    query_insert = text("INSERT INTO Records(user_id,symptom,illness,treatment,checkin_date,severity) VALUES ('{}',{},'{}','','{}','{}');".format(user,sym,ill,today,sev))
